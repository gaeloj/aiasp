...
import { 
  ...
  Menu, X, Sparkles, LayoutDashboard, Calendar, UserCheck, Settings, FileText, Receipt
} from 'lucide-react';
    ...
    <div className="min-h-screen bg-[#0a0a0a] flex flex-col md:flex-row text-gray-200">
      ...
      <div className="md:hidden bg-[#111111] border-b border-white/5 px-4 py-3 flex justify-between items-center sticky top-0 z-30 shadow-md">
        <div className="flex items-center gap-2">
          <div className="h-8 w-8 bg-white/5 border border-white/10 rounded-lg flex items-center justify-center text-white overflow-hidden shrink-0">
            {entityConfig?.logo ? (
              <img 
          ...
          <span className="font-extrabold text-white text-sm tracking-tight">{entityConfig?.acronym || 'UniOn'}</span>
      ...
      `}>
        ...
        <div className="space-y-6">
          ...
          <div className="h-16 border-b border-white/5 flex items-center gap-3 px-6 shrink-0 bg-[#1a1a1a]/40">
            <div className="h-9 w-9 bg-white/5 border border-white/10 rounded-xl flex items-center justify-center text-white overflow-hidden shrink-0">
              {entityConfig?.logo ? (
                <img 
                  src={entityConfig.logo} 
                  alt="Logo" 
            ...
            <div className="min-w-0">
              <span className="font-extrabold text-white text-xs sm:text-sm tracking-tight block leading-tight truncate">{entityConfig?.name || 'UniOn'}</span>
